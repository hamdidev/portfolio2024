...
export const HeroSection = () => {
  return (
    ...
    //       <button className="inline-flex items-center gap-2 border boreder-white/15 px-6 h-12 rounded-xl cursor-pointer">
    ...
    <section
      id="hero"
      className="py-32 md:py-48 lg:py-64 relative z-10 overflow-x-clip"
    >
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)] -z-10 pointer-events-none">
        <div
